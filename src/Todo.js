...
const Todo = () => {
    ...
    return (
        <>
            <div className="todo__wrapper bg-white rounded-xl shadow-xl p-8 box-border my-12" data-aos="zoom-in-up" data-aos-duration="5000">
                        ...
                        return (
                            <>
                                <div className="todos flex flex-row items-center py-4 px-5 bg-white shadow-xl text-gray-700 my-4 rounded-lg" key={id}>
                                    <span className="todo__text flex flex-grow"
                                    >{element}</span>
